...
public class HoverTextColor : MonoBehaviour
{
    ...
    public void SetHoverColor()
    {
        if (_textElement != null)
        {
            ...
            if (SceneManager.GetActiveScene().name == "StartGame") AudioManager.instance.PlaySfx(SFXSoundType.MetalClick);
            else AudioManager.instance.PlaySfx(SFXSoundType.RadioBeep);
        }
